	...
	<div style="margin: 0 auto; width: 50%; margin-top: 50px;">
		<div>
			<div class="well bs-component">
				...
				<form:form id="registerForm" modelAttribute="location" method="post" action="save" class="form-horizontal">
					<fieldset>
						...
						<div class="form-group">
							<div class="col-md-9 col-md-offset-3">
								<a href="home" class="btn btn-danger">Cancelar</a> <input type="submit" value="Salvar" class="btn btn-success" />
							</div>
						</div>
					</fieldset>
				</form:form>
